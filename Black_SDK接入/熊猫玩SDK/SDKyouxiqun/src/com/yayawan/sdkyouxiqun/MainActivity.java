package com.yayawan.sdkyouxiqun;
	...
	public void login(View v) {
        ...
        GameProxy.getInstent().login(this, new YYWUserCallBack() {
            ...
            public void onLoginSuccess(YYWUser user, Object arg1) {
               ...
               // Toast.makeText(MainActivity.this, "播放动画回调" + user, Toast.LENGTH_SHORT).show();
            }
	 ...
	 public void pay(View v) {
	        YYWOrder order = new YYWOrder(UUID.randomUUID().toString(), "霜之哀伤", 500l,  "xxxx");
