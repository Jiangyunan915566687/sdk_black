...
public class YaYawanconstants {
	...
	public static void logoAnim(final Activity mactivity){
		...
		YaYaWan.getInstance().anim(mactivity, new YYWAnimCallBack(){
	...
	public static void onPause(Activity paramActivity) {
		YaYaWan.getInstance().onPause(paramActivity);
	}
	public static void onResume(Activity paramActivity) {
		YaYaWan.getInstance().onResume(paramActivity);
	}
	public static void onRestart(Activity paramActivity) {
		YaYaWan.getInstance().onRestart(paramActivity);
	}
	public static void onStop(Activity paramActivity) {
		YaYaWan.getInstance().onStop(paramActivity);
	}
	public static void onDestroy(Activity paramActivity) {
		YaYaWan.getInstance().onDestroy(paramActivity);
	}
