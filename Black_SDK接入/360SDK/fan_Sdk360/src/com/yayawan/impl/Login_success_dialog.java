...
public class Login_success_dialog {
	...
	public void dialogShow() {
		...
		new Thread(new Runnable() {
			...
			public void run() {
				...
				mHandler.sendEmptyMessageDelayed(CLOSE, 4000);
			}
		}).start();
		;
	}
	...
	public void createDialog(Activity mActivity) {
		...
		machineFactory.MachineTextView(tv_message1, WRAP_CONTENT, WRAP_CONTENT,
				0, " 警告:", tv_textsize, mLinearLayout, 10, 0, 0, 0);
		...
		machineFactory.MachineTextView(tv_userid, WRAP_CONTENT, WRAP_CONTENT,
				0, "检测到您是未成年人,您将三小时后收益减半", tv_textsize, mLinearLayout, 0, 0, 0, 0);
